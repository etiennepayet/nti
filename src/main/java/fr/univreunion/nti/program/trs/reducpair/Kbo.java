 ...
 *
 * <p>The implemented definition is from F. Baader and T. Nipkow,
 * <a href="https://doi.org/10.1017/CBO9781139172752">Term Rewriting and
 * All That</a>, Cambridge University Press, 1998, Sect. 5.4.
 *
...
public class Kbo implements ReducPair {
	...
	public boolean complete(Collection<PairOfTerms> c) {
		...
		for (PairOfTerms pair : c)
			if (!pair.left().
					completeKBO(this.lexo, this.wf, pair.right()))
				return false;
	...
	public String toString(int indentation) {
		...
		return indent + "Knuth-Bendix order induced by the precedence: " + this.lexo
				+ "\n" + indent + "and the weight function: " + this.wf;
	}
}
