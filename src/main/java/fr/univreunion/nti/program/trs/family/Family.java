...
public class Family {
	 ...
	 */
	private final Set<FunctionSymbol> reachable = new HashSet<>();
	...
	/**
	 * Adds all the symbols in the specified set
	...
	public boolean contains(Term t) {
		...
		for (int i = 0; i < this.arguments.length; i++) {
			Family thisArgument = this.arguments[i];
			if (thisArgument != null && !thisArgument.contains(t.get(i))) return false;
		}
