...
public class ParentTrsComp extends ParentTrs {
	 ...
	 * the left-hand side
	 */
    public static synchronized ParentTrsComp of(
			UnfoldedRuleTrsComp father, RuleTrs mother,
			Position position, boolean unfoldsLeftSide) {

		return new ParentTrsComp(father, mother, position, unfoldsLeftSide);
	}
	 ...
	 * the left-hand side
	 */
	private ParentTrsComp(UnfoldedRuleTrsComp father, RuleTrs mother,
			Position position, boolean unfoldsLeftSide) {
	...
	public String toString(int indentation) {
		...
		if (this.getMother() == null) {
			...
			s.append("the subterm at position ");
			s.append(p);
			s.append(" in the left-hand side of the second rule of ").append(l).append(".");
		}
		else if (this.getPosition().isEmpty()) {
			s.append("\n");
			s.append(spaces);
			s.append("We merge the first and the second rule of ").append(l).append(".");
		}
		else {
			s.append("\n");
			s.append(spaces);
