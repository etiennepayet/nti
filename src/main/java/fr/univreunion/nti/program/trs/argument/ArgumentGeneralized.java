...
public class ArgumentGeneralized implements Argument {
	 ...
	 * rewrite rule.
	 *
	 * @param rule the generalized rewrite rule that
	 * provides this argument
	 */
	public ArgumentGeneralized(RuleTrs rule) {
		this.rule = rule;
	}
	...
	public String toString() {
		...
		String certificate = this.rule.getLeft().toString(variables, false);
		...
		return
				...
				"in the analyzed TRS:\n" +
				this.rule.toString(variables, false) +
