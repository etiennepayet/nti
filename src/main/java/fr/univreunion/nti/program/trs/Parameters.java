...
public class Parameters {
	 ...
	 */
	private static final boolean DEFAULT_UNFOLD_FORWARDS = true;

	/**
	 * The default behavior w.r.t. backward unfolding.
	 * Used while searching for loops.
	 */
	private static final boolean DEFAULT_UNFOLD_BACKWARDS = true;

	/**
	 * The default behavior w.r.t. variable unfolding.
	 * Used while searching for loops.
	 */
	private static final boolean DEFAULT_VARIABLE_UNFOLDING_ENABLED = false;
	 ...
	 */
	private static final StrategyLoop DEFAULT_STRATEGY = StrategyLoop.LEFTMOST_NE;

	/**
	 * The default verbosity mode.
	 */
	...
	/**
	 * True if and only if unfolding must keep parent information
	 * for verbose proof output.
	 */
	...
	public Parameters() {
		...
		this.unfoldVar = DEFAULT_VARIABLE_UNFOLDING_ENABLED;
		this.maxDepth = DEFAULT_MAX_DEPTH;
		this.strategy = DEFAULT_STRATEGY;
		this.verbose = DEFAULT_VERBOSITY;
	}
	...
	/**
	 * Returns {@code true} if and only if forward unfolding
	 * is enabled.
	 * 
	 * @return {@code true} if and only if forward unfolding
	 * is enabled
	 */
	...
	/**
	 * Returns {@code true} if and only if backward unfolding
	 * is enabled.
	 * 
	 * @return {@code true} if and only if backward unfolding
	 * is enabled
	 */
	...
	/**
	 * Returns {@code true} if and only if unfolding of variable
	 * positions is enabled.
	 * 
	 * @return {@code true} if and only if unfolding of variable
	 * positions is enabled
	 */
	...
	/**
	 * Returns <code>true</code> if and only if unfolding must
	 * keep parent information for verbose proof output.
	 *
	 * @return <code>true</code> if and only if unfolding must
	 * keep parent information for verbose proof output
	 */
	 ...
	 *
	 * @param verbose <code>true</code> if and only if unfolding
	 * must keep parent information for verbose proof output
	 */
	public synchronized void setVerboseMode(boolean verbose) {
