...
public interface Polynomial {
	 ...
	 * with respect to the given variable
	 */
    Polynomial partialDerivative(Variable v);
	 ...
	 */
    Polynomial replaceWithMu(Deque<Variable> variables, PolynomialConst mu);
	 ...
	 * an <code>Integer</code>
	 */
    Integer integerValue(Map<Variable, Integer> interpretation);
	 ...
	 * of this polynomial
	 */
    Collection<Polynomial> getMonomials();
	 ...
	 */
    String toString(Map<Variable, String> variables);
}
