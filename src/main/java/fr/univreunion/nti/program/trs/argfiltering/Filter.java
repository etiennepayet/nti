...
public class Filter {
	 ...
	 * while the argument position is
	 * non-<code>null</code>.
	 */
	 ...
	 * while the list of argument positions
	 ...
	 */
	public Filter(FunctionSymbol symbol) {
	 ...
	 * argument position.
	 * 
	 * @param position an argument position, supposed to be
	 ...
	 * 
	 * @param positions a list of argument positions, supposed
	 ...
	 */
	public void setValue(List<Integer> positions) {
