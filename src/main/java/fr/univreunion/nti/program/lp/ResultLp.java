...
public class ResultLp {
	 ...
	 * non-termination of the specified mode
	 * could be proved.
	 * 
	 * @author <A HREF="mailto:etienne.payet@univ-reunion.fr">Etienne Payet</A>
	 */
	...
	/**
	 * Returns a result indicating that the specified mode could be proved
	 * terminating.
	 * 
	 * @param proof the proof of the returned result
	 */
	public static ResultLp yes(Proof proof) {
	 ...
	 * @param proof the proof of the returned result
	 */
	public static ResultLp no(Proof proof) {
		return new ResultLp(ResultType.NO, proof);
	}
	
	/**
	 * Returns a result indicating that the specified mode could not be proved
	 * terminating or non-terminating.
	 * 
	 * @param proof the proof of the returned result
	 */
	public static ResultLp maybe(Proof proof) {
	 ...
	 * @param proof the proof of the returned result
	 */
	public static ResultLp error(Proof proof) {
	...
	/**
	 * Checks whether the specified mode could be proved terminating.
	 * 
	 * @return <code>true</code> iff the specified mode could be proved
	 * terminating
	 */
	...
	/**
	 * Checks whether the specified mode could be proved non-terminating.
	 * 
	 * @return <code>true</code> iff the specified mode could be proved
	 * non-terminating
	 */
	...
	/**
	 * Checks whether the specified mode could not be proved terminating or
	 * non-terminating.
	 * 
	 * @return <code>true</code> iff this result
	 * indicates that the specified mode could not
