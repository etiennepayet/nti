...
public class HatFunctionSymbol extends FunctionSymbol {
	...
	/**
	 * Returns the canonical hat symbol for the specified
	 * 1-context, creating it if no such symbol exists yet.
	 * <p>
	 * <b>It is supposed that <code>simpleContext</code>
	 ...
	 * @param simpleContext a 1-context
	 * @param x the hole of <code>simpleContext</code>
	 * @return the canonical hat symbol for the specified
	 * 1-context
	 * @throws IllegalArgumentException if
	 * <code>simpleContext == x</code>
	 */
	public static HatFunctionSymbol intern(Term simpleContext, Variable x) {
		if (simpleContext == x)
	 ...
	 */
    public static synchronized String toStringSymbolTable() {
